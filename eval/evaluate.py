    ...
    with tempfile.TemporaryDirectory() as tmp_dir_name:
        ...
        for spec in TEST_SET:
            ...
            if spec["id"] == "synthetic_vulnerable_app_1":
                ...
                (sample_repo_path / "src/services/stripe.js").write_text("const stripeKey = 'sk_test_51NxYz';")
...
if __name__ == "__main__":
    ...
    print(f"Overall F1 Score  : {overall_metrics['f1_score']:.2%}")    cat_match = expected["category"].lower() in actual.get("category", "").lower()
    file_match = expected["file"] in actual.get("file", "")
